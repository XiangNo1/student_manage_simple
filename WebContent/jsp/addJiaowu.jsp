		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/banji?method=findJiaowuServlet" class="list-group-item">教务查询</a>
		                <a href="${pageContext.request.contextPath}/banji?method=manageJiaowuServlet" class="list-group-item active">为班级添加课程</a>
		            </div>
		        </div>
		        <div class="col-md-10">
		           ...
		           <form action="${pageContext.request.contextPath}/banji?method=addJiaowuServlet" method="post">
