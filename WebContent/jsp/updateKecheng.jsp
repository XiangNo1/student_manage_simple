  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/kecheng?method=findKechengServlet" class="list-group-item active">课程管理</a>
		        ...
		        <div class="col-md-10">
		            <ul class="nav nav-tabs">
		                <li class="active">
		                    <a href="${pageContext.request.contextPath}/kecheng?method=findKechengServlet">课程管理</a>
		                </li>
		                <li>
		...
		<form action="${pageContext.request.contextPath }/banji?method=updateKechengServlet" method="post">
 		id：<input class="form-control" type="text" name="id" value="${requestScope.kecheng.id }" readonly="readonly"/><br/>
   		    班级：<input class="form-control" type="text" name="name" value="${requestScope.kecheng.name }"/><br/>
