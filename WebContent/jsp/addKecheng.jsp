...
<link rel="stylesheet" href="${pageContext.request.contextPath }/lib/bootstrap/css/bootstrap.css" />
		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/banji?method=findKechengServlet" class="list-group-item">课程管理</a>
		                <a href="${pageContext.request.contextPath}/banji?method=addKechengToServlet" class="list-group-item active">课程添加</a>
		            </div>
		        </div>
		        <div class="col-md-10">
 ...
 <form action="/Java1707Web2/banji?method=addKechengServlet" method="post">
	...
	$(function() {
		$("#name").blur(function(){
	        var name = $(this).val();
	        $.post(
				"${pageContext.request.contextPath}/banji?method=checkKechengName",
						{"name":name},
						function(data) {
							if(data.isExit){
