...
<link rel="stylesheet" href="${pageContext.request.contextPath }/lib/bootstrap/css/bootstrap.css" />
  ...
  <div class="container-fluid">
		    ...
		    <div class="row">
				...
				<c:forEach items="${requestScope.list}" var="banji">
					<tr>
						...
						<td><a href='${pageContext.request.contextPath }/banji?method=findBanjiById&id=${banji.id }'>修改</a></td>
					</tr>
				</c:forEach>
		                </tbody>
		            </table>
	...
	function delStudent(id) {
	       ...
	       if (isDel) {
	           //要删除
	           location.href = "${pageContext.request.contextPath}/banji?method=deleteBanjiServlet&id="
	                  + id;
	       }
	    }
