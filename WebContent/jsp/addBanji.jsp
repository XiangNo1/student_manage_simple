  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/banji?method=findBanjiServlet"> <span class="glyphicon glyphicon-home" aria-hidden="true"></span> 班级管理 </a></li>
		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/banji?method=findBanjiServlet" class="list-group-item">班级管理</a>
		                <a href="${pageContext.request.contextPath}/banji?method=AddBanjiToServlet" class="list-group-item active">班级添加</a>
		            </div>
		        </div>
		        <div class="col-md-10">
		            <ul class="nav nav-tabs">
		                <li>
		                    <a href="${pageContext.request.contextPath}/banji?method=findBanjiServlet">班级管理</a>
		                </li>
		                <li class="active">
		                     <a href="${pageContext.request.contextPath}/banji?method=AddBanjiToServlet">班级添加</a>
		                </li>
		            </ul>
				      
		             <div style="width:60%; margin-top:20px;">
		             <div class="alert alert-danger" role="alert">请不要添加重复的班级！！！</div>
 <form action="/Java1707Web2/banji?method=addBanjiServlet" method="post">
   	    班级：<input class="form-control" type="text" name="name" id="name"/><br/>
	...
	$(function() {
		$("#name").blur(function(){
	        var name = $(this).val();
	        $.post(
				"${pageContext.request.contextPath}/banji?method=checkBanjiName",
						{"name":name},
						function(data) {
							if(data.isExit){
								$("#nameInfo").html("该班级已经存在");
								$("#nameInfo").css("color", "red");
							}else{
								$("#nameInfo").html("该班级名称可用");
