  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/banji?method=findBanjiServlet" class="list-group-item active">班级管理</a>
		                <a href="${pageContext.request.contextPath}/banji?method=AddBanjiToServlet" class="list-group-item">班级添加</a>
		            </div>
		        </div>
		        <div class="col-md-10">
		...
		<form action="${pageContext.request.contextPath }/banji?method=updateBanjiServlet" method="post">
 		id：<input class="form-control" type="text" name="id" value="${requestScope.banji.id }" readonly="readonly"/><br/>
   		    班级：<input class="form-control" type="text" name="name" value="${requestScope.banji.name }"/><br/>
